...
import MinterTx from '../../node_modules/minterjs-tx';
import MinterTxSignature from '../../node_modules/minterjs-tx/src/tx-signature';
import {formatCoin} from '../../node_modules/minterjs-tx/src/helpers';
import ethUtil from '../../node_modules/ethereumjs-util';
	...
	return function postTx(txParams) {
		...
		return new Promise((resolve, reject) => {
			...
			.then((nonce) => {
				...
				minterNode.post('/api/sendTransactionAsync', {
